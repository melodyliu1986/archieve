...
def advanced_search_str(attribute_select, attribute, attribute_text):
    """
    This function is used for advanced search. Different search method have different sql.
    :param attribute_select: select_method eg: contains, does not contain or others.
    :param attribute: attribute eg: arch, multiplier
    :param attribute_text: attribute value eg: multiplier - 25
    :return: str
    """
    if attribute != "id":
        ...
        search_attribute_text = '(fn.Lower(SkuEntry.id) % "%")'
