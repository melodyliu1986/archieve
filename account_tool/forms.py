...
from choices import choices, attribute_choices, select_choices
...
class SearchBySkuAttribute(Form):
    ...
    data_search_attribute_text1 = StringField(label="", validators=[DataRequired()])
    ...
    data_search_attribute5 = SelectField(label="SKU Attribute 5:", choices=attribute_choices)
    data_search_select5 = SelectField(label="", choices=select_choices)
    data_search_attribute_text5 = StringField(label="")

    submit_search_attribute = SubmitField("Search")


class SearchByEngAttribute(Form):
    data_search_eng = StringField(label="*Eng ProductId(s):",
                                  description="Please fill in the Eng ProductId(s) you want to search, such as 69 or 69,180."
                                              " Search with 69,180 and 180,69 should have the same result.",
                                  validators=[DataRequired()])

    submit_search_eng = SubmitField("Search")
